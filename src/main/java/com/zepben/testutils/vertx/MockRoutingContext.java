...
public class MockRoutingContext {
    ...
    public static class Builder {
        ...
        public RoutingContext build() {
            ...
            if (pathParams != null)
                doReturn(pathParams).when(context).get(RoutingContextEx.PATH_PARAMS_KEY);
            else
                doReturn(new PathParams(pathParamsMap)).when(context).get(RoutingContextEx.PATH_PARAMS_KEY);

            if (queryParams != null)
                doReturn(queryParams).when(context).get(RoutingContextEx.QUERY_PARAMS_KEY);
            else
                doReturn(new QueryParams(queryParamRules, queryParamsMap)).when(context).get(RoutingContextEx.QUERY_PARAMS_KEY);
